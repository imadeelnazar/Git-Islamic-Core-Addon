		...
		$this->add_control(
			...
			[
				...
				'default' => esc_html__( 'event-grid-view', 'essential-addons-elementor' ),
		     	'options' 		=> [				
					'event-simple-view' => esc_html__('Event Simple View', 'jobly'),							
					// 'event-grid-view' => esc_html__('Event Grid View', 'jobly'),
					// 'event-medium-view' => esc_html__('Event Medium View', 'jobly'),
					// 'event-medium-modern-view' => esc_html__('Event Medium Modern View', 'jobly'),
					// 'event-full-view' => esc_html__('Event Full Normal', 'jobly')
		     	],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => esc_html__( 'all', 'essential-addons-elementor' ),
		     	'options' 		=> [				
					'past' => esc_html__('Past Events', 'jobly'), 
					'future' => esc_html__('Upcoming Events', 'jobly'), 
					'all' => esc_html__('All Events', 'jobly'), 
		     	],
			]
		);
	...
	protected function render() {		
		...
		<div class="events-item-wrapper events-<?php echo esc_attr( $this->get_id() ); ?>">
			...
			if(class_exists('EM_Events')){
				...
				echo wpha_get_events_item($settings);
			}
			?>
		</div>
		<?php 
